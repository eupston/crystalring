...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.audiostreamer.AudioSample.displayName =
    'proto.audiostreamer.AudioSample';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.audiostreamer.AudioSample.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.audiostreamer.AudioSample.deserializeBinary = function (bytes) {
  ...
  return proto.audiostreamer.AudioSample.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.audiostreamer.AudioSample}
 */
proto.audiostreamer.AudioSample.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.audiostreamer.AudioSample.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
